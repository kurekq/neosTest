...
namespace ECOM
{
//ERRSOURCE: ECOM.BR_KLIENCI_CENY

  public partial class BR_KLIENCI_CENY
  {
    [UUID("766eb7891bdf43fb9e6ed35262f2e91f")]
    virtual public string SetDBQuery()
    {
    	string template = "from BR_KLIENCI_CENY({0}, {1}, {2}, {3})";
    	
    	return string.Format(template,
    						 _klient.SQLString(true), _oddzial.SQLString(true), _stanowisko.SQLString(true),
    						 _datacen.SQLString(true));
