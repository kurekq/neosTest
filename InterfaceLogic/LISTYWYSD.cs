...
namespace ECOM
{
//ERRSOURCE: ECOM.LISTYWYSD

  public partial class LISTYWYSD
  {
    [UUID("4132373abeec4d36b5ad012c85ddbf69")]
    virtual public void AddShippingDocToEcomorder()
    {
        var ecomOrder = ParentObject as ECOM.ECOMORDERS;
        ecomOrder.LISTWYSDREF = this.REF;
        if(!ecomOrder.PostRecord())
        {
          throw new Exception($"Błąd zapisu listu spedycyjnego o REF: {this.REF} do bazy danych");
        }	
    }
    ...
    /// </summary>
    [UUID("79ccefc89d5541f4a4efa73fae5d212f")]
