...
namespace ECOM
{
//ERRSOURCE: ECOM.CENNIK

  public partial class CENNIK
  {

  }
	//ERRSOURCE: structure PriceChanged { ... } in object ECOM.CENNIK
  [CustomData("DataStructure=Y")]
  [UUID("a57e754342354dcfb8ad9659e37fdb0d")]
  public class PriceChanged : NeosEvent
  {
	...
	//ERRSOURCE: structure PriceDeleted { ... } in object ECOM.CENNIK
  [CustomData("DataStructure=Y")]
  [UUID("b24c0a096053479397fbb48588dc5756")]
  public class PriceDeleted : NeosEvent
  {
    public int DefcennikRef {get; set;}
    public int WersjaRef {get; set;}
    public int TowjednRef {get; set;}
