...
namespace ECOM
{
//ERRSOURCE: ECOM.ECOMCHANNELSGROUPS

  public partial class ECOMCHANNELSGROUPS
  {
    [UUID("37a95bed255b426c9ccfb8444717aae6")]
    virtual public void ShowChannelsInGroup()
    {
      if (this.REF.AsInteger > 0)
      {
        Contexts c = new Contexts();
        c.Add("_ecomchannelgroup", this.REF.AsInteger);
        GUI.ShowForm("ECOM.ECOMCHANNELSINGROUP", "BROWSE", c);   
      }
    }
    
    

    [UUID("acfcf06b23894f438b96f930bf9ef50b")]
    ...
    /// </summary>
    [UUID("cf011212738646ab912bdb7ffab7de05")]
