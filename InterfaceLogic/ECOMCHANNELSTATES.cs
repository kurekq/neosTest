...
{
/// <summary>
/// Obiekt z listą statusów dla kanału sprzedaży
/// </summary>
//ERRSOURCE: ECOM.ECOMCHANNELSTATES

  public partial class ECOMCHANNELSTATES
  {
    /// <summary>
    /// automatycznie wygenerowana metoda na inicjalizację pola REF
    /// </summary>
    [UUID("9053c45875e44ac79af72c6db455f2c0")]
    virtual public string InitializeREF()
    {
      return GenRef();
    }
  }
	//ERRSOURCE: structure CheckOrderStateUpdateResult { ... } in object ECOM.ECOMCHANNELSTATES
  [CustomData("DataStructure=Y")]
  [UUID("57f49dbb1bbd486888021c51150b23f8")]
  public struct CheckOrderStateUpdateResult
  {
    public bool StateHasChanged { get; set; }
    public EcomOrderStatusInfo OrderStatusInfo {get; set;}
  }
}
