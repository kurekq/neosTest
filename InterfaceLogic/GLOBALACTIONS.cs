...
//ERRSOURCE: ECOM.GLOBALACTIONS
  ...
  public partial class GLOBALACTIONS
  {
    ...
    [CustomData("Usings=;Neos.BusinessPlatform.Devel;")]
    [UUID("bc7ff7014e8f4dd2abc8fc7919b2cf08")]
    public static void BrowseECOMCHANNELS()
    {
      Contexts c = new Contexts();
      c.Add("_schowonlyactive","1");
      GUI.ShowForm("ECOM.ECOMCHANNELS", "BROWSE",c);
    }
  }
