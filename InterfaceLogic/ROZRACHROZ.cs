...
namespace ECOM
{
//ERRSOURCE: ECOM.ROZRACHROZ

  public partial class ROZRACHROZ
  {
    [UUID("69b153140bcc4032866237205aab27d8")]
    virtual public string SetDBFilter()
    {
      return $"DOKREF = '{this._dokref}'";
    }
    ...
    /// </summary>
    [UUID("83092bcc3dbe4e2ca3897fe5165b9bbb")]
