...
namespace ECOM
{
//ERRSOURCE: ECOM.BR_TOWARY_STANY

  public partial class BR_TOWARY_STANY
  {
    [UUID("16851c175a574611bc7cd7b2001d9492")]
    virtual public string SetDBQuery()
    {
    	string template = "from BR_TOWARY_STANY({0}, {1}, {2})";
    	return string.Format(template,
    						 _wersjaref.SQLInteger(true), _oddzial.SQLString(true), _magazyn.SQLString(true));
    }
  }
